    ...
    methods
        ...
        function onCheckboxprotocolUpdate(o,hsource,data)
            if hsource.Value ==1
                ...
                datestringreduced = datestring(end-9:end);
                path = [o.compositor.camera.protocolpath datestring '/' datestringreduced '_' o.compositor.currentabsorptionimage(14:17) '_t_proto.dat'];
                currentprotocol = load([o.compositor.camera.protocolpath datestring '/mat/' datestringreduced '_' o.compositor.currentabsorptionimage(14:17) '_t_proto.mat']);
                error = false;
                catch
                    pause(1);
                end
...
%             set(o.seldata2, 'String',o.selectedIDs{end});
        ...
        function onCreate(o)
            ...
            o.checkboxprotocol = uicontrol('Style','checkbox',...
                ...
                'Value',o.compositor.loadprotocol,...
