    ...
    methods
        ...
        function onRadioClick(o,hSource,callbackdata,iRadio)
            ...
            elseif get(o.radios(3),'Value')
                o.compositor.species = '7Li';
            elseif get(o.radios(4),'Value')
                o.compositor.species = '6Li';
            end
        ...
        function processData(o)
            ...
            if strcmp(o.compositor.species,'K')
            ...
            elseif strcmp(o.compositor.species,'Rb')
                %o.compositor.camera = Camera(o.compositor.cameraID,o.compositor.species);
                DetuningRb = 0e6;
                GammaRb    = 2.*pi.*6.0666e6   ; % Linienbreite des zyklischen Uebergangs aus "Alkali D Line Data", Daniel Steck - August 2009
                LambdaRb    = 780.241209686e-9 ; % Rubidium D2 Detektionswellenlaenge, entnommen aus "Steck"
                ...
                elseif strcmp(o.compositor.species,'6Li')
                %o.compositor.camera = Camera(o.compositor.cameraID,o.compositor.species);
                DetuningLi6_D2 = 0e6;
                ...
                elseif strcmp(o.compositor.species,'7Li')
                %o.compositor.camera = Camera(o.compositor.cameraID,o.compositor.species);
                DetuningLi7_D2 = 0e6;
