classdef PixelQuenchFigure < FitBaseFigure
    properties
        quenchTimeSeries
        fftApprox
        fitApprox
    ...
    methods
        ...
        function processData(o)
            ...
            o.quenchTimeSeries = zeros(numel(o.times),1);
            for iqt =1:numel(hs)
        ...
        function onReplot(o)
            o.processData();
            o.plot = plot(o.axes, o.times, o.quenchTimeSeries,'.-b');
        end
