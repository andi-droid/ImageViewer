classdef CroppedImageFigure < ImageBaseFigure
    ...
    methods
        ...
        function onRedraw(o)
            ...
            o.roicenter(1) = o.compositor.figures{2}.abscenter(1)-o.compositor.roi(1);
            o.roicenter(2) = o.compositor.figures{2}.abscenter(2)-o.compositor.roi(2);
