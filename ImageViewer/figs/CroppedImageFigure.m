classdef CroppedImageFigure < ImageBaseFigure
    ...
    methods
        ...
        function onEnterslidermax(o,hObject,callbackdata)
            o.slidermax = str2double(get(hObject,'string'));
            set(o.cmapslider, 'Max', o.slidermax);
        end
        ...
        function onCreate(o)
            ...
            slidermaxtext = uicontrol(o.figure, 'Style', 'text', 'String', 'SliderMax',...
                'Units', 'normalized',...
                'Position', [0 0.9 0.15 0.1]);
            
            o.slidermaxedit = uicontrol(o.figure, 'Style', 'edit',...
                'Units', 'normalized',...
                'String',num2str(o.slidermax),...
                'Position', [0 0.85 0.15 0.1],...
                'Callback', {@o.onEnterslidermax});
            
            o.cmapslider = uicontrol('Style', 'slider',...
                'units', 'normalized',...
                'Position', [0.05 0.2 0.05 0.6],...
                'Min', 0,...
                'Max', o.slidermax,...
                'Value',0.1,...
