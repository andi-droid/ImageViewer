classdef HistoryFigure < BaseFigure
    ...
    methods
        ...
        function onUpdateFluo(o,hsource,data)
            if o.compositor.fluoq
            o.onClearBtnPush(o.clearbtn);
            set(o.popupanalysis,'visible','off');
            set(o.popupanalysisfluo,'visible','on');
            else
            o.onClearBtnPush(o.clearbtn);
            set(o.popupanalysis,'visible','on');
            set(o.popupanalysisfluo,'visible','off');
            end
        end
        ...
        function onUseFitResults(o,hsource,data)
            ...
            %             if o.compositor.fitorcount
                ...
                o.compositor.intcountshistory(end+1)    = o.compositor.intcounts;
                o.compositor.fitcountshistory(end+1)    = o.compositor.atomnumberfitmean./o.compositor.camera.Atomfaktor;
    
                o.compositor.atomnumberhistory(end+1)   = o.compositor.atomnumberfitmean;
                o.compositor.atomnumberhistoryx(end+1)  = o.compositor.atomsx;
                o.compositor.atomnumberhistoryy(end+1)  = o.compositor.atomsy;
...
%         end
        ...
        function processData(o)
            ...
            o.IntCounts = o.compositor.intcountshistory;
            o.FitCounts = o.compositor.fitcountshistory;
            o.integratedOD = o.compositor.atomnumberhistory;
            o.integratedODx = o.compositor.atomnumberhistoryx;
            o.integratedODy = o.compositor.atomnumberhistoryy;
        ...
        function onCreate(o)
            ...
            addlistener(o.compositor, 'onChangeFluo', @o.onUpdateFluo);
            ...
            o.popupanalysis = uicontrol('Style', 'popupmenu',...
                'String', {'Atomnumber','AtomnumberX','AtomnumberY','Width','Position'},...
                'units', 'normalized',...
                'Position', [0.4 0.95 0.2 0.05],...
                'Callback', @o.setAnalysisMethod);
            
            o.popupanalysisfluo = uicontrol('Style', 'popupmenu',...
                'String', {'IntCounts','FitCounts'},...
                'units', 'normalized',...
                'Position', [0.4 0.95 0.2 0.05],...
                'Callback', @o.setAnalysisMethod);
...
%             end
        ...
        function onReplot(o)
            o.processData();
           if o.compositor.fluoq
               if o.popupanalysisfluo.Value == 1
                o.plot = plot(o.axes,o.xaxisdata, o.IntCounts,'or');
                grid(o.axes,'on');
                xlabel(o.axes,o.compositor.history_xlab);
                ylabel(o.axes,'IntCounts');
                o.axes.YScale = 'lin';
                %o.axes.YLim = [0,2e8];
                %o.axes.YLim = [0,20e7];
               else
                o.plot = plot(o.axes,o.xaxisdata, o.FitCounts,'ob');
                grid(o.axes,'on');
                xlabel(o.axes,o.compositor.history_xlab);
                ylabel(o.axes,'FitCounts');
                o.axes.YScale = 'lin';
                %o.axes.YLim = [45,200];
                hold(o.axes,'off');
               end
            ...
            if o.popupanalysis.Value == 1
                o.plot = plot(o.axes,o.xaxisdata, o.integratedOD,'ok');
                grid(o.axes,'on');
                xlabel(o.axes,o.compositor.history_xlab);
            ...
            elseif o.popupanalysis.Value == 2
                ...
                grid(o.axes,'on');
                xlabel(o.axes,o.compositor.history_xlab);
                ylabel(o.axes,'AtomnumberX');
                o.axes.YScale = 'lin';
                %o.axes.YLim = [45,200];
                hold(o.axes,'off');
            elseif o.popupanalysis.Value == 3
                o.plot = plot(o.axes,o.xaxisdata, o.integratedODy,'ob');
                grid(o.axes,'on');
                xlabel(o.axes,o.compositor.history_xlab);
                ylabel(o.axes,'AtomnumberY');
                o.axes.YScale = 'lin';
                %o.axes.YLim = [45,200];
                hold(o.axes,'off');    
            elseif o.popupanalysis.Value == 4
