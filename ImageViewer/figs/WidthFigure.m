classdef WidthFigure < BaseFigure
    properties
        % GUI elements
        checkboxfitorcount
        clearbtn
    ...
    methods
        ...
        function onUseFitResults(o,hsource,data)
            ...
            if o.compositor.fitorcount
                ...
                o.compositor.widthhistory(1,end+1) = o.compositor.fitdatax(4);
                o.compositor.widthhistory(2,end+1) = o.compositor.fitdatay(4);
        ...
        function processData(o)
            ...
            if numel(o.compositor.widthhistory) > 0
            o.widthx = squeeze(o.compositor.widthhistory(1,:));
            o.widthy = squeeze(o.compositor.widthhistory(2,:));
            end
        ...
        function onReplot(o)
            o.processData();
            o.plot = plot(o.axes,o.xaxisdata, o.widthx,'.r');
            hold(o.axes,'on')
            o.plot2 = plot(o.axes,o.xaxisdata, o.widthy,'.b');
            grid(o.axes,'on');
