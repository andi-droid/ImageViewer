classdef ProtocolFigure < BaseFigure
    ...
    methods
        ...
        function setVariable(o,hSource,callbackdata)
            items = get(hSource,'String');
            index_selected = get(hSource,'Value');
            item_selected = items{index_selected};
            o.compositor.history_xlab = item_selected;
            o.compositor.analysis_xlab = item_selected;
            o.compositor.indexvariables = index_selected;
            notify(o.compositor,'updateAnalysis');
        end
        ...
        function onCreate(o)
            ...
            for iRadio=1:numel(o.radioLabels)
                o.radios(iRadio) = uicontrol(o.figure, 'Style', 'radiobutton', ...
                    ...
                    'String',   o.radioLabels{iRadio}, ...
                    'Value',    iRadio==1);
            end
            
            o.popupanalysis = uicontrol('Style', 'popupmenu',...
                'String', {'Atomnumber','AtomnumberX','AtomnumberY','Position','Position X','Position Y','Mask 1+2 BZ','Momentum resolved','Ratio 2 Areas','Width X','Width Y'},...
                'units', 'normalized',...
        ...
        function onReplot(o)
            ...
            try
                ...
                if get(o.radios(5),'Value')
                    o.popupvariables = uicontrol('Style', 'popupmenu',...
                        'String', o.compositor.protocolpackage{1,1}.p.VariableName,...
                        'units', 'normalized',...
                        'Position', [0.30 0.22 0.3 0.1],...
                        'Callback', @o.setVariable);
                end
