classdef Camera < handle
    properties
        ...
        imageDirectoryNode = '//afs/physnet.uni-hamburg.de/project/bfm/Daten/2017/';
    end
...
ISatLi6_D1 = pi.*hPlanck*cspeed*GammaLi6_D1/(3.*(LambdaLi6_D1^3)) ; %S�ttigungsintensit�t der Li6 D1-Linie
ISatLi6_D2 = pi.*hPlanck*cspeed*GammaLi6_D2/(3.*(LambdaLi6_D2^3)) ; %S�ttigungsintensit�t der Li6 D2-Linie

ISatLi7_D1 = pi.*hPlanck*cspeed*GammaLi7_D1/(3.*(LambdaLi7_D1^3)) ; %S�ttigungsintensit�t der Li7 D1-Linie
ISatLi7_D2 = pi.*hPlanck*cspeed*GammaLi7_D2/(3.*(LambdaLi7_D2^3)) ; %S�ttigungsintensit�t der Li7 D2-Linie
