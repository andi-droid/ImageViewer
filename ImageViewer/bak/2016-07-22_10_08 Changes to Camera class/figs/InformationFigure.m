    ...
    methods
        ...
        function processFit(o)
            ...
            if strcmp(o.compositor.cameraID, 'Andor')
                ...
                o.AtomfaktorRb = (o.compositor.camera{cameraNr}.PixSize.^2/o.compositor.camera{cameraNr}.magnification.^2) .* 2 .* pi .* (1+ 4.*(DetuningRb.^2/GammaRb.^2)) ./ (3.*LambdaRb.^2);
                y_index = 1:size(o.compositor.croppedimage,1);
                x_index = 1:size(o.compositor.croppedimage,2);
                [Xb,Yb] = meshgrid(x_index,y_index);
        ...
        function processData(o)
            ...
            if o.compositor.species == 'K'
                ...
                o.AtomfaktorK  = (o.compositor.camera{cameraNr}.PixSize.^2/o.compositor.camera{cameraNr}.magnification.^2) .* 2 .* pi .* (1+ 4.*(DetuningK.^2/GammaK.^2)) ./ (3.*LambdaK.^2);
