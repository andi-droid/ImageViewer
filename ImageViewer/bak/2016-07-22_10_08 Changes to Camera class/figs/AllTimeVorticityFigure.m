classdef AllTimeVorticityFigure < FitBaseFigure
    properties
        val
        valNonInterp
        run
    ...
    methods
        % constructor
        function o = AllTimeVorticityFigure()
...
%             o.run = o.compositor.userIndeces.run.value;
            ...
            imbalance2 = o.compositor.userIndeces.imbalance2.value;
            time = o.compositor.userIndeces.time.value;
            runs = 15*(imbalance-1)+imbalance2-1;
            %s = ismember(o.data.parameters(:,2), runs);
